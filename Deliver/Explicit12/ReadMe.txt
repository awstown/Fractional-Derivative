...
%
% explicit02.m (This is the main script you should be working in)
% 
% This script is used to numerically solve the 1D diffusion-wave equation:
% (d^gamma U / dt^gamma) = K * (d^2 U / dx^2), which allows for 
% 1 < gamma < 2. This method will only work for these values.
%
