%% A Script that solves the diffusion equation, with the fractional derivative 
% in the Caputo form. To be used with \gamma(fdorder) 0 to 1. The explicit 
%
% Thanks to John Jasbinsek(J^3) for the inspiration.
%
%
...
fdorder = 1;     % The fractional order of the derivative (\gamma)
...
if ~isStable(S, fdorder)
    error('The system is not stable. Please, choose a different dx or dt');
end
...
%% Exact Solution - This is a where you would put an analytical soln.
